...
exports.index = function(req, res){
    ...
    Q.all([
        ...
        Doctor.find().skip(skip).limit(limit) //jumlah data
    ])
...
exports.search = function(req,res){
    ...
    Doctor.find({ name: { $regex: req.query.value, $options: 'i' } }).exec(function(err, doctors){
...
exports.show = function(req, res){
    ...
    Doctor.findOne({ _id: req.params.id }).exec(function(err, doctor){
        if(err)return res.status(500).send(err);
...
exports.update = function(req, res){
     ...
     Doctor.findOne({ _id: req.params.id }).exec(function(err, doctor){
        ...
        updated.save(function(err){
            ...
            res.status(200).json({ massage: 'Doctor Updated', doctor: updated });
        });
    });
}
